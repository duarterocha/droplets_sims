...
class Mesh(GmshTemplate):
    ...
    def define_geometry(self):
        ...
        p_surface_infinity = self.point(self.radius * ((3 - 1) + sin(self.contact_angle)) * S, 0)
        p_apex_infinity = self.point(0, self.radius * (3 - cos(self.contact_angle)) * S)
        ...
        self.circle_arc(p_surface_infinity, p_apex_infinity, center=p_center, name="gas_infinity")
