    ...
    double _res_contrib,_J_contrib;
    {
      ...
      for (unsigned int l_test=0;l_test<eleminfo->nnode_C2;l_test++)
      {
        ...
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind__kin_bc],6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*( shapeinfo->normal[ipt][0]*this_intrp_d0t0_d0x_velocity_x+shapeinfo->normal[ipt][1]*this_intrp_d0t0_d0x_velocity_y)*testfunction[l_test], shapeinfo->hanginfo_C2,this_nodalind__kin_bc,l_test)
          ...
          END_JACOBIAN()
        END_RESIDUAL_CONTINUOUS_SPACE()
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_velocity_x],-2.0000000000000000e+00*dx*( 3.1415926535897931e+00*shapeinfo->normal[ipt][0]*this_intrp_d0t0_d0x__kin_bc*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+3.1415926535897931e+00*(*(my_func_table->global_parameters[0]))*this_intrp_d0t0_d0x_coordinate_x*this_intrp_d0t0_d0x_T*( 1.0/this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+dx_testfunction[l_test][0])), shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind__kin_bc], -6.2831853071795862e+00*dx*shapeinfo->normal[ipt][0]*shapeinfo->shape_C2[ipt][l_shape]*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test],shapeinfo->hanginfo_C2,this_nodalind__kin_bc,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_T], -6.2831853071795862e+00*dx*(*(my_func_table->global_parameters[0]))*this_intrp_d0t0_d0x_coordinate_x*shapeinfo->shape_C2[ipt][l_shape]*( 1.0/this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+dx_testfunction[l_test][0]),shapeinfo->hanginfo_C2,this_nodalind_T,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
            }
          END_JACOBIAN()
        END_RESIDUAL_CONTINUOUS_SPACE()
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_velocity_y],-2.0000000000000000e+00*dx*( 3.1415926535897931e+00*(*(my_func_table->global_parameters[0]))*this_intrp_d0t0_d0x_coordinate_x*this_intrp_d0t0_d0x_T*dx_testfunction[l_test][1]+3.1415926535897931e+00*shapeinfo->normal[ipt][1]*this_intrp_d0t0_d0x__kin_bc*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]), shapeinfo->hanginfo_C2,this_nodalind_velocity_y,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
      ...
      for (unsigned int l_test=0;l_test<eleminfo->nnode_C2;l_test++)
      {
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_velocity_x],-6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*this_intrp_d0t0_d0x_T*( 1.0/this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+dx_testfunction[l_test][0]), shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_test)
          ...
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_T], -6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*shapeinfo->shape_C2[ipt][l_shape]*( 1.0/this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+dx_testfunction[l_test][0]),shapeinfo->hanginfo_C2,this_nodalind_T,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
            }
          END_JACOBIAN()
