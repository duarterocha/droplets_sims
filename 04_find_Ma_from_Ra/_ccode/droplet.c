...
static void ResidualAndJacobian0(const JITElementInfo_t * eleminfo, const JITShapeInfo_t * shapeinfo,double * residuals, double *jacobian, double *mass_matrix,unsigned flag)
{
 ...
 double * dt=shapeinfo->dt;
  ...
  const unsigned this_nodalind___EXT_ODE_0 = 5;
 ...
 //Subexpressions // TODO: Check whether it is constant to take it out of the loop
    ...
    double _res_contrib,_J_contrib;
    {
      ...
      {
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_T],2.0000000000000000e+00*dx*( 3.1415926535897931e+00*this_intrp_d1t0BDF2_d0x_T*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+3.1415926535897931e+00*( this_intrp_d0t0_d0x_velocity_x*this_intrp_d0t0_d1x0_T+this_intrp_d0t0_d0x_velocity_y*this_intrp_d0t0_d1x1_T)*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+3.1415926535897931e+00*( this_intrp_d0t0_d1x0_T*dx_testfunction[l_test][0]+this_intrp_d0t0_d1x1_T*dx_testfunction[l_test][1])*this_intrp_d0t0_d0x_coordinate_x), shapeinfo->hanginfo_C2,this_nodalind_T,l_test)
        ...
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_streamfunc],-2.0000000000000000e+00*dx*( 3.1415926535897931e+00*( this_intrp_d0t0_d1x0_streamfunc*dx_testfunction[l_test][0]+this_intrp_d0t0_d1x1_streamfunc*dx_testfunction[l_test][1])*this_intrp_d0t0_d0x_coordinate_x+3.1415926535897931e+00*( 2.0000000000000000e+00*this_intrp_d0t0_d0x_velocity_y-this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d1x1_velocity_x-this_intrp_d0t0_d1x0_velocity_y))*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]), shapeinfo->hanginfo_C2,this_nodalind_streamfunc,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_x], 6.2831853071795862e+00*dx*shapeinfo->dx_shape_C2[ipt][l_shape][1]*pow(this_intrp_d0t0_d0x_coordinate_x,2.0)*testfunction[l_test],shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_y], -6.2831853071795862e+00*dx*( 2.0000000000000000e+00*shapeinfo->shape_C2[ipt][l_shape]+shapeinfo->dx_shape_C2[ipt][l_shape][0]*this_intrp_d0t0_d0x_coordinate_x)*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test],shapeinfo->hanginfo_C2,this_nodalind_velocity_y,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_streamfunc], -6.2831853071795862e+00*( shapeinfo->dx_shape_C2[ipt][l_shape][0]*dx_testfunction[l_test][0]+shapeinfo->dx_shape_C2[ipt][l_shape][1]*dx_testfunction[l_test][1])*dx*this_intrp_d0t0_d0x_coordinate_x,shapeinfo->hanginfo_C2,this_nodalind_streamfunc,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
            }
          END_JACOBIAN()
        END_RESIDUAL_CONTINUOUS_SPACE()
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_velocity_x],6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*( 1.0/this_intrp_d0t0_d0x_coordinate_x*( 2.0000000000000000e+00*this_intrp_d0t0_d0x_velocity_x/this_intrp_d0t0_d0x_coordinate_x-this_intrp_d0t0_d0x_pressure)*testfunction[l_test]+( 2.0000000000000000e+00*this_intrp_d0t0_d1x0_velocity_x-this_intrp_d0t0_d0x_pressure)*dx_testfunction[l_test][0]+( this_intrp_d0t0_d1x1_velocity_x+this_intrp_d0t0_d1x0_velocity_y)*dx_testfunction[l_test][1]), shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_x], 6.2831853071795862e+00*( 2.0000000000000000e+00*shapeinfo->dx_shape_C2[ipt][l_shape][0]*dx_testfunction[l_test][0]+shapeinfo->dx_shape_C2[ipt][l_shape][1]*dx_testfunction[l_test][1]+2.0000000000000000e+00*shapeinfo->shape_C2[ipt][l_shape]/pow(this_intrp_d0t0_d0x_coordinate_x,2.0)*testfunction[l_test])*dx*this_intrp_d0t0_d0x_coordinate_x,shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
            ...
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C1;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_pressure], -6.2831853071795862e+00*( shapeinfo->shape_C1[ipt][l_shape]*dx_testfunction[l_test][0]+shapeinfo->shape_C1[ipt][l_shape]/this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test])*dx*this_intrp_d0t0_d0x_coordinate_x,shapeinfo->hanginfo_C1,this_nodalind_pressure,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
            }
          END_JACOBIAN()
        END_RESIDUAL_CONTINUOUS_SPACE()
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_velocity_y],-2.0000000000000000e+00*dx*( -3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( ( 2.0000000000000000e+00*this_intrp_d0t0_d1x1_velocity_y-this_intrp_d0t0_d0x_pressure)*dx_testfunction[l_test][1]+( this_intrp_d0t0_d1x1_velocity_x+this_intrp_d0t0_d1x0_velocity_y)*dx_testfunction[l_test][0])+3.1415926535897931e+00*(*(my_func_table->global_parameters[0]))*this_intrp_d0t0_d0x_T*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]), shapeinfo->hanginfo_C2,this_nodalind_velocity_y,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
    ...
    }
    {
      ...
      {
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_pressure],6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d0x_velocity_x/this_intrp_d0t0_d0x_coordinate_x+this_intrp_d0t0_d1x0_velocity_x+this_intrp_d0t0_d1x1_velocity_y)*testfunction[l_test], shapeinfo->hanginfo_C1,this_nodalind_pressure,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_x], 6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]*( shapeinfo->shape_C2[ipt][l_shape]/this_intrp_d0t0_d0x_coordinate_x+shapeinfo->dx_shape_C2[ipt][l_shape][0]),shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
    ...
    {
        BEGIN_RESIDUAL(eleminfo->nodal_local_eqn[0][this_nodalind___EXT_ODE_0], 5.0000000000000000e-01*( tanh(1.0000000000000000e+07*this_intrp_d0t0_d0x_streamfunc)+9.7999999999999998e-01)*dx*1)
          ADD_TO_RESIDUAL()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_streamfunc], -5.0000000000000000e+06*dx*( pow(tanh(1.0000000000000000e+07*this_intrp_d0t0_d0x_streamfunc),2.0)-1.0000000000000000e+00)*shapeinfo->shape_C2[ipt][l_shape]*1,shapeinfo->hanginfo_C2,this_nodalind_streamfunc,l_shape)
                ADD_TO_JACOBIAN_NOHANG_HANG()
              END_JACOBIAN_HANG()
            }
          END_JACOBIAN()
        END_RESIDUAL()
...
static double EvalIntegralExpression(const JITElementInfo_t * eleminfo, const JITShapeInfo_t * shapeinfo, unsigned index)
{
  ...
  for(unsigned ipt=0;ipt<shapeinfo->n_int_pt;ipt++)
  {
    ...
    switch (index)
    {
      ...
      case 2 :  res+= ( pow(this_intrp_d0t0_d0x_velocity_x,2.0)+pow(this_intrp_d0t0_d0x_velocity_y,2.0))*dx*this_intrp_d0t0_d0x_coordinate_x; break; // _v_sqr_int [ 2*Pi ]
...
JIT_API void JIT_ELEMENT_init(JITFuncSpec_Table_FiniteElement_t *functable)
{
 ...
 functable->temporal_error_scales=calloc(12,sizeof(double)); 
 functable->discontinuous_refinement_exponents=calloc(12,sizeof(double));
 functable->num_ICs=1;
 ...
 functable->Dirichlet_set_size=9;
 ...
 SET_INTERNAL_FIELD_NAME(functable->Dirichlet_names,8, "__EXT_ODE_0" );
