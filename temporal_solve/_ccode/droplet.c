...
static void ResidualAndJacobian0(const JITElementInfo_t * eleminfo, const JITShapeInfo_t * shapeinfo,double * residuals, double *jacobian, double *mass_matrix,unsigned flag)
{
 ...
 //Subexpressions // TODO: Check whether it is constant to take it out of the loop
    ...
    double _res_contrib,_J_contrib;
    {
      ...
      {
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_T],2.0000000000000000e+00*dx*( 3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d0x_velocity_x*this_intrp_d0t0_d1x0_T+this_intrp_d0t0_d0x_velocity_y*this_intrp_d0t0_d1x1_T)*testfunction[l_test]+3.1415926535897931e+00*this_intrp_d1t0BDF2_d0x_T*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d1x1_T*dx_testfunction[l_test][1]+this_intrp_d0t0_d1x0_T*dx_testfunction[l_test][0])), shapeinfo->hanginfo_C2,this_nodalind_T,l_test)
          ...
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              ...
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_y], 6.2831853071795862e+00*dx*shapeinfo->shape_C2[ipt][l_shape]*this_intrp_d0t0_d1x1_T*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test],shapeinfo->hanginfo_C2,this_nodalind_velocity_y,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_T], 2.0000000000000000e+00*dx*( 3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d0x_velocity_x*shapeinfo->dx_shape_C2[ipt][l_shape][0]+this_intrp_d0t0_d0x_velocity_y*shapeinfo->dx_shape_C2[ipt][l_shape][1])*testfunction[l_test]+3.1415926535897931e+00*shapeinfo->timestepper_weights_dt_BDF2_degr[0]*shapeinfo->shape_C2[ipt][l_shape]*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( shapeinfo->dx_shape_C2[ipt][l_shape][1]*dx_testfunction[l_test][1]+shapeinfo->dx_shape_C2[ipt][l_shape][0]*dx_testfunction[l_test][0])),shapeinfo->hanginfo_C2,this_nodalind_T,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
        ...
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_streamfunc],2.0000000000000000e+00*( -3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d1x1_streamfunc*dx_testfunction[l_test][1]+this_intrp_d0t0_d1x0_streamfunc*dx_testfunction[l_test][0])+3.1415926535897931e+00*this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d0x_coordinate_x*( this_intrp_d0t0_d1x1_velocity_x-this_intrp_d0t0_d1x0_velocity_y)+-2.0000000000000000e+00*this_intrp_d0t0_d0x_velocity_y)*testfunction[l_test])*dx, shapeinfo->hanginfo_C2,this_nodalind_streamfunc,l_test)
          ADD_TO_RESIDUAL_CONTINUOUS_SPACE()
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              ...
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_y], -6.2831853071795862e+00*dx*( 2.0000000000000000e+00*shapeinfo->shape_C2[ipt][l_shape]+shapeinfo->dx_shape_C2[ipt][l_shape][0]*this_intrp_d0t0_d0x_coordinate_x)*this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test],shapeinfo->hanginfo_C2,this_nodalind_velocity_y,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_streamfunc], -6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*( shapeinfo->dx_shape_C2[ipt][l_shape][1]*dx_testfunction[l_test][1]+shapeinfo->dx_shape_C2[ipt][l_shape][0]*dx_testfunction[l_test][0]),shapeinfo->hanginfo_C2,this_nodalind_streamfunc,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
            }
          END_JACOBIAN()
        ...
        BEGIN_RESIDUAL_CONTINUOUS_SPACE(eleminfo->nodal_local_eqn[l_test][this_nodalind_velocity_x],6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*( ( 2.0000000000000000e+00*this_intrp_d0t0_d1x0_velocity_x-this_intrp_d0t0_d0x_pressure)*dx_testfunction[l_test][0]+( 2.0000000000000000e+00*this_intrp_d0t0_d0x_velocity_x/this_intrp_d0t0_d0x_coordinate_x-this_intrp_d0t0_d0x_pressure)/this_intrp_d0t0_d0x_coordinate_x*testfunction[l_test]+( this_intrp_d0t0_d1x1_velocity_x+this_intrp_d0t0_d1x0_velocity_y)*dx_testfunction[l_test][1]), shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_test)
          ...
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_x], 6.2831853071795862e+00*dx*this_intrp_d0t0_d0x_coordinate_x*( 2.0000000000000000e+00*shapeinfo->shape_C2[ipt][l_shape]/pow(this_intrp_d0t0_d0x_coordinate_x,2.0)*testfunction[l_test]+shapeinfo->dx_shape_C2[ipt][l_shape][1]*dx_testfunction[l_test][1]+2.0000000000000000e+00*shapeinfo->dx_shape_C2[ipt][l_shape][0]*dx_testfunction[l_test][0]),shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
          ...
          BEGIN_JACOBIAN()
            for (unsigned int l_shape=0;l_shape<eleminfo->nnode_C2;l_shape++)
            {
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_x], 6.2831853071795862e+00*dx*shapeinfo->dx_shape_C2[ipt][l_shape][1]*this_intrp_d0t0_d0x_coordinate_x*dx_testfunction[l_test][0],shapeinfo->hanginfo_C2,this_nodalind_velocity_x,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
              BEGIN_JACOBIAN_HANG(eleminfo->nodal_local_eqn[l_shape][this_nodalind_velocity_y], 6.2831853071795862e+00*dx*( 2.0000000000000000e+00*shapeinfo->dx_shape_C2[ipt][l_shape][1]*dx_testfunction[l_test][1]+shapeinfo->dx_shape_C2[ipt][l_shape][0]*dx_testfunction[l_test][0])*this_intrp_d0t0_d0x_coordinate_x,shapeinfo->hanginfo_C2,this_nodalind_velocity_y,l_shape)
                ADD_TO_JACOBIAN_HANG_HANG()
              END_JACOBIAN_HANG()
